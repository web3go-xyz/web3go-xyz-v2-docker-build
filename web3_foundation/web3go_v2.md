...
| 2. | UI Module:general WebApp | https://web3go.xyz | Production: [https://web3go.xyz](https://dev-v2.web3go.xyz/) ; To reproduce locally, following the testing guide for UI: https://github.com/web3go-xyz/portal-ui/blob/main/testing-with-dockerfile.md |
